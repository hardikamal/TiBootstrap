...
/**
 Base class for all TiBootstrap views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the TiBootstrap view hierarchy (such as wrapped iOS UIViews) was touched.
